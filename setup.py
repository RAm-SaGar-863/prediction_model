...
URL = 'https://github.com/RAm-SaGar-863'
EMAIL = 'ramsagarkaduthuri@gmail.com'
AUTHOR = 'Ram Sagar Kaduthuri'
REQUIRES_PYTHON = '>=3.7.0'

pwd = os.path.abspath(os.path.dirname(__file__))

# Get th list of packages to be installed
def list_reqs(fname='requirements.txt'):
    with io.open(os.open.join(pwd,fname),encoding='utf-8') as f:
